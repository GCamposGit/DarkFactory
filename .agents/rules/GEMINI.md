...
2. **Hierarquia de Execução Híbrida (Local-First -> Nuvem)**:
   ...
   - **Nuvem de Fronteira**: Para planejamento arquitetural e PRDs complexos, acione **Claude Opus 5** ou **GPT-6 Astra**. Para raciocínio analítico e verificação independente em nuvem na fronteira de Pareto de 2026, acione **DeepSeek V4.1 Flash** ($0.15/M). Para pesquisas externas vivas e documentações dinâmicas, consulte **Grok 4.6**.
